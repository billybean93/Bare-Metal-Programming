...
static command_t commands[] = {
    ...
    {"teamImage", "teamImage - display image with team members names", cmd_task2},
    {"video", "video - display video of cat dancing", cmd_task3},
...
static int cmd_task2(int argc, char **argv)
{
    uart_puts("Displaying an epic image with names of team members.\n");
    adjustGameScreen();
    drawBgAndNames();
    return 0;
}
static int cmd_task3(int argc, char **argv)
{
    uart_puts("Displaying a video of cat dancing\n");
    adjustVideoScreen();
    display_video(0, 0, CAT_DANCE_WIDTH, CAT_DANCE_HEIGHT, frames_order, NUM_FRAMES, 1000000);
